    ...
    <div style={{ minHeight: "100vh", background: "#f8fafc", padding: isMobile ? "16px" : "32px", fontFamily: "'Inter', sans-serif" }}>
      ...
      {loading ? (
        ...
        <div style={{ textAlign: "center", padding: "64px 24px", background: "white", borderRadius: 12, border: "1px solid #e2e8f0", boxShadow: "0 4px 6px -1px rgba(0, 0, 0, 0.05)" }}>
          ...
          <h3 style={{ margin: "0 0 8px", color: "#0f172a", fontSize: FONT_SIZE.xl, fontWeight: 600 }}>No truck officers yet</h3>
          <p style={{ color: "#64748b", fontSize: FONT_SIZE.base, margin: "0 0 24px", maxWidth: 400, marginLeft: "auto", marginRight: "auto" }}>Add truck officers to manage vehicle assignments and maintenance.</p>
          <button onClick={() => { if (!canEdit) return; setShowInviteModal(true); setMessage("") }} style={{ padding: "10px 20px", background: canEdit ? "white" : "#94a3b8", color: "#0f172a", border: "1px solid #cbd5e1", borderRadius: 8, cursor: canEdit ? "pointer" : "not-allowed", fontWeight: 500, fontSize: FONT_SIZE.base, transition: "all 0.2s ease" }} onMouseEnter={e => e.currentTarget.style.background = "#f8fafc"} onMouseLeave={e => e.currentTarget.style.background = "white"}>
            Add First Officer
          </button>
        </div>
      ) : (
                ...
                return (
                  <div key={m.manager_id} style={{ background: "white", borderRadius: 12, padding: 16, border: "1px solid #e2e8f0", boxShadow: "0 1px 3px rgba(0, 0, 0, 0.05)", transition: "all 0.2s ease" }} onMouseEnter={e => { e.currentTarget.style.boxShadow = "0 4px 12px rgba(0, 0, 0, 0.08)"; e.currentTarget.style.borderColor = "#cbd5e1" }} onMouseLeave={e => { e.currentTarget.style.boxShadow = "0 1px 3px rgba(0, 0, 0, 0.05)"; e.currentTarget.style.borderColor = "#e2e8f0" }}>
                    <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 12 }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 12, flex: 1, minWidth: 0 }}>
                        ...
                        <div style={{ minWidth: 0 }}>
                          <h3 style={{ margin: "0 0 4px 0", color: "#0f172a", fontSize: FONT_SIZE.lg, fontWeight: 600, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{m.full_name}</h3>
                          <p style={{ margin: 0, color: "#64748b", fontSize: FONT_SIZE.sm, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{m.phone_number || "No phone number"}</p>
                        </div>
                      </div>
                      <span style={{ padding: "4px 10px", borderRadius: 6, fontSize: FONT_SIZE.xs, background: bg, color: color, border: `1px solid ${border}`, fontWeight: 500, flexShrink: 0 }}>
                        {m.status}
                      </span>
                    </div>
                    ...
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: 12, padding: "12px 0 0", borderTop: "1px solid #f1f5f9" }}>
                      <span style={{ fontSize: FONT_SIZE.sm, color: "#475569", fontWeight: 500 }}>
                        {m.truck_count} {m.truck_count === 1 ? "truck" : "trucks"} assigned
                      </span>
                      <div style={{ display: "flex", gap: 8 }}>
                        <button onClick={() => { if (!canEdit) return; setAssigningManager(m); fetchTrucksForAssignment(m.manager_id); setAssignError("") }} style={{ padding: "8px 12px", cursor: canEdit ? "pointer" : "not-allowed", borderRadius: 6, border: "1px solid #e2e8f0", color: canEdit ? "#2f855a" : "#94a3b8", background: canEdit ? "#f0fdf4" : "#e2e8f0", fontSize: FONT_SIZE.sm, fontWeight: 500, transition: "all 0.2s" }} onMouseEnter={e => { if (!canEdit) return; e.currentTarget.style.background = "#ecfdf5"; e.currentTarget.style.borderColor = "#2f855a" }} onMouseLeave={e => { if (!canEdit) return; e.currentTarget.style.background = "#f0fdf4"; e.currentTarget.style.borderColor = "#e2e8f0" }}>
                          Assign
                        </button>
                        <button onClick={() => { if (!canEdit) return; setEditingManager(m); setEditName(m.full_name); setEditPhone(m.phone_number || ""); setMessage("") }} style={{ padding: "8px 12px", cursor: canEdit ? "pointer" : "not-allowed", borderRadius: 6, border: "1px solid #e2e8f0", color: canEdit ? "#0070f3" : "#94a3b8", background: canEdit ? "#f0f7ff" : "#e2e8f0", fontSize: FONT_SIZE.sm, fontWeight: 500, transition: "all 0.2s" }} onMouseEnter={e => { if (!canEdit) return; e.currentTarget.style.background = "#e0efff"; e.currentTarget.style.borderColor = "#0070f3" }} onMouseLeave={e => { if (!canEdit) return; e.currentTarget.style.background = "#f0f7ff"; e.currentTarget.style.borderColor = "#e2e8f0" }}>
                          Edit
                        </button>
                        <button onClick={() => { if (!canEdit) return; setDeletingId(m.manager_id); setMessage("") }} style={{ padding: "8px 12px", cursor: canEdit ? "pointer" : "not-allowed", borderRadius: 6, border: "1px solid #fee2e2", color: canEdit ? "#ef4444" : "#94a3b8", background: canEdit ? "#fef2f2" : "#e2e8f0", fontSize: FONT_SIZE.sm, fontWeight: 500, transition: "all 0.2s" }} onMouseEnter={e => { if (!canEdit) return; e.currentTarget.style.background = "#fee2e2" }} onMouseLeave={e => { if (!canEdit) return; e.currentTarget.style.background = "#fef2f2" }}>
                          Delete
                        </button>
                      </div>
                    </div>
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", textAlign: "left" }}>
                <thead>
                  <tr style={{ background: "#f8fafc", borderBottom: "1px solid #e2e8f0" }}>
                    ...
                    <th style={{ padding: "12px 16px", fontWeight: 600, fontSize: FONT_SIZE.xs, color: "#64748b", textTransform: "uppercase", letterSpacing: "0.5px" }}>Trucks</th>
                      ...
                      <tr key={m.manager_id} style={{ borderBottom: idx === managers.length - 1 ? "none" : "1px solid #e2e8f0", transition: "background 0.2s ease" }} onMouseEnter={e => e.currentTarget.style.background = "#f8fafc"} onMouseLeave={e => e.currentTarget.style.background = "transparent"}>
                        <td style={{ padding: "12px 16px" }}>
                          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                            ...
                            <span style={{ color: "#0f172a", fontSize: FONT_SIZE.base, fontWeight: 500 }}>{m.full_name}</span>
                          </div>
                        </td>
                        ...
                        <td style={{ padding: "12px 16px", color: "#475569", fontSize: FONT_SIZE.sm, fontWeight: 500 }}>
                          {m.truck_count} {m.truck_count === 1 ? "truck" : "trucks"} assigned
                        </td>
                        <td style={{ padding: "12px 16px" }}>
                          <span style={{ padding: "4px 10px", borderRadius: 6, fontSize: FONT_SIZE.xs, background: bg, color: color, border: `1px solid ${border}`, fontWeight: 500, display: "inline-block" }}>
                            {m.status}
                          </span>
                        </td>
                        <td style={{ padding: "12px 16px", textAlign: "right" }}>
                          <div style={{ display: "flex", gap: 6, justifyContent: "flex-end" }}>
                            <button onClick={() => { if (!canEdit) return; setAssigningManager(m); fetchTrucksForAssignment(m.manager_id); setAssignError("") }} style={{ padding: "6px 10px", cursor: canEdit ? "pointer" : "not-allowed", borderRadius: 5, border: "1px solid #e2e8f0", color: canEdit ? "#2f855a" : "#94a3b8", background: canEdit ? "#f0fdf4" : "#e2e8f0", fontSize: FONT_SIZE.sm, fontWeight: 500, transition: "all 0.2s", minHeight: 32, minWidth: 32, display: "flex", alignItems: "center", justifyContent: "center" }} onMouseEnter={e => { if (!canEdit) return; e.currentTarget.style.background = "#ecfdf5"; e.currentTarget.style.borderColor = "#2f855a" }} onMouseLeave={e => { if (!canEdit) return; e.currentTarget.style.background = "#f0fdf4"; e.currentTarget.style.borderColor = "#e2e8f0" }}>
                              Assign
                            </button>
                            <button onClick={() => { if (!canEdit) return; setEditingManager(m); setEditName(m.full_name); setEditPhone(m.phone_number || ""); setMessage("") }} style={{ padding: "6px 10px", cursor: canEdit ? "pointer" : "not-allowed", borderRadius: 5, border: "1px solid #e2e8f0", color: canEdit ? "#0070f3" : "#94a3b8", background: canEdit ? "#f0f7ff" : "#e2e8f0", fontSize: FONT_SIZE.sm, fontWeight: 500, transition: "all 0.2s", minHeight: 32, minWidth: 32, display: "flex", alignItems: "center", justifyContent: "center" }} onMouseEnter={e => { if (!canEdit) return; e.currentTarget.style.background = "#e0efff"; e.currentTarget.style.borderColor = "#0070f3" }} onMouseLeave={e => { if (!canEdit) return; e.currentTarget.style.background = "#f0f7ff"; e.currentTarget.style.borderColor = "#e2e8f0" }}>
                              Edit
                            </button>
                            <button onClick={() => { if (!canEdit) return; setDeletingId(m.manager_id); setMessage("") }} style={{ padding: "6px 10px", cursor: canEdit ? "pointer" : "not-allowed", borderRadius: 5, border: "1px solid #fee2e2", color: canEdit ? "#ef4444" : "#94a3b8", background: canEdit ? "#fef2f2" : "#e2e8f0", fontSize: FONT_SIZE.sm, fontWeight: 500, transition: "all 0.2s", minHeight: 32, minWidth: 32, display: "flex", alignItems: "center", justifyContent: "center" }} onMouseEnter={e => { if (!canEdit) return; e.currentTarget.style.background = "#fee2e2" }} onMouseLeave={e => { if (!canEdit) return; e.currentTarget.style.background = "#fef2f2" }}>
                              Delete
                            </button>
                          </div>
                        </td>
        ...
        <div style={{ position: "fixed", inset: 0, background: "rgba(15, 23, 42, 0.6)", backdropFilter: "blur(4px)", display: "flex", alignItems: isMobile ? "flex-end" : "center", justifyContent: "center", zIndex: 100, padding: isMobile ? 0 : 24, animation: "fadeIn 0.2s ease-out" }}>
          ...
          <div style={{ background: "white", borderRadius: isMobile ? "20px 20px 0 0" : 12, padding: isMobile ? "28px 20px" : 32, width: "100%", maxWidth: assigningManager ? 540 : 420, maxHeight: "90vh", overflowY: "auto", boxShadow: "0 25px 50px -12px rgba(0, 0, 0, 0.25)", animation: "slideUp 0.3s cubic-bezier(0.16, 1, 0.3, 1)" }}>
                ...
                {inviteResult ? (
                  ...
                  <>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 24 }}>
                      <h3 style={{ margin: 0, color: "#0f172a", fontSize: FONT_SIZE.xl, fontWeight: 700 }}>Add Truck Officer</h3>
            ...
            {editingManager && (
              <>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 24 }}>
                  <h3 style={{ margin: 0, color: "#0f172a", fontSize: FONT_SIZE.xl, fontWeight: 700 }}>Edit Officer</h3>
                  <button onClick={closeModals} style={{ background: "none", border: "none", color: "#94a3b8", cursor: "pointer", padding: 0, width: 32, height: 32, display: "flex", alignItems: "center", justifyContent: "center", transition: "color 0.2s" }} onMouseEnter={e => e.currentTarget.style.color = "#64748b"} onMouseLeave={e => e.currentTarget.style.color = "#94a3b8"}><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="6" x2="6" y2="18" /><line x1="6" y1="6" x2="18" y2="18" /></svg></button>
                </div>
                <div style={{ display: "flex", flexDirection: "column", gap: 14, marginBottom: 20 }}>
                  <div>
            ...
            {deletingId && (
              <>
                <div style={{ display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center" }}>
                  ...
                  <h3 style={{ margin: "0 0 12px", color: "#0f172a", fontSize: FONT_SIZE.xl, fontWeight: 700 }}>Delete Truck Officer</h3>
                  <p style={{ margin: "0 0 20px", color: "#64748b", fontSize: FONT_SIZE.base, lineHeight: 1.5 }}>Are you sure? This will also remove all their truck assignments.</p>
            ...
            {assigningManager && (
              <>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 20 }}>
                  <div>
                    <h3 style={{ margin: 0, color: "#0f172a", fontSize: FONT_SIZE.xl, fontWeight: 700 }}>Assign Trucks</h3>
                    <p style={{ margin: "6px 0 0", color: "#64748b", fontSize: FONT_SIZE.sm }}>
                ...
                {assignError && (
                  <div style={{ background: "#fffbeb", border: "1px solid #fcd34d", borderRadius: 8, padding: "12px 14px", marginBottom: 16 }}>
                    <p style={{ margin: 0, fontSize: FONT_SIZE.sm, color: "#78350f", lineHeight: 1.4 }}>{assignError}</p>
                    {assignError.includes("assigned to") && (
                      <button onClick={() => { if (!canEdit || !pendingPlate) return; handleForceAssign(pendingPlate) }} style={{ marginTop: 8, padding: "6px 12px", fontSize: FONT_SIZE.sm, cursor: canEdit ? "pointer" : "not-allowed", background: canEdit ? "#fcd34d" : "#94a3b8", color: canEdit ? "#78350f" : "#94a3b8", border: "none", borderRadius: 4, fontWeight: 500 }}>
                        Reassign Anyway
                      </button>
                    )}
                  </div>
                ...
                {trucksLoading && <p style={{ color: "#64748b", fontSize: FONT_SIZE.sm, textAlign: "center", padding: "20px 0" }}>Loading trucks...</p>}

                {!trucksLoading && (
                  <>
                    {assignedToThis.length > 0 && (
                      <div style={{ marginBottom: 16 }}>
                        <p style={{ fontWeight: 500, marginBottom: 8, fontSize: FONT_SIZE.sm, color: "#475569" }}>Currently Assigned</p>
                        <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                          {assignedToThis.map((t) => (
                            <div key={t.plate_number} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "10px 12px", background: "#f0fdf4", border: "1px solid #a7f3d0", borderRadius: 6 }}>
                              <div>
                                <span style={{ fontWeight: 500, fontSize: FONT_SIZE.sm, color: "#0f172a" }}>{t.plate_number}</span>
                                <span style={{ fontSize: FONT_SIZE.xs, color: "#64748b", marginLeft: 8 }}>{t.truck_model}</span>
                              </div>
                              <button onClick={() => { if (!canEdit) return; handleUnassignTruck(t.plate_number) }} style={{ padding: "4px 10px", fontSize: FONT_SIZE.xs, cursor: canEdit ? "pointer" : "not-allowed", background: canEdit ? "white" : "#e2e8f0", border: "1px solid #fee2e2", color: canEdit ? "#ef4444" : "#94a3b8", borderRadius: 4, fontWeight: 500, transition: "all 0.2s" }} onMouseEnter={e => { if (!canEdit) return; e.currentTarget.style.background = "#fee2e2" }} onMouseLeave={e => { if (!canEdit) return; e.currentTarget.style.background = "white" }}>
                                Remove
                              </button>
                            </div>
                          ))}
                    ...
                    {unassignedTrucks.length > 0 && (
                      <div style={{ marginBottom: 16 }}>
                        <p style={{ fontWeight: 500, marginBottom: 8, fontSize: FONT_SIZE.sm, color: "#475569" }}>Available Trucks</p>
                        <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                    ...
                    {assignedToOthers.length > 0 && (
                      <div>
                        <p style={{ fontWeight: 500, marginBottom: 8, fontSize: FONT_SIZE.sm, color: "#64748b" }}>Assigned to Others</p>
                        <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                    ...
                    {unassignedTrucks.length === 0 && assignedToOthers.length === 0 && assignedToThis.length === 0 && (
                      <p style={{ color: "#64748b", fontSize: FONT_SIZE.sm, textAlign: "center", padding: "20px 0" }}>No trucks in system</p>
                    )}
                  </>
                )}

                <div style={{ marginTop: 20, display: "flex", justifyContent: "flex-end" }}>
                  <button onClick={closeModals} style={{ padding: "10px 24px", background: "#0070f3", color: "white", border: "none", borderRadius: 8, cursor: "pointer", fontWeight: 600, fontSize: FONT_SIZE.md, minHeight: 40 }}>
                    Done
                  </button>
                </div>
              </>
