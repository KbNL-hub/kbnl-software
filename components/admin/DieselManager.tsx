                ...
                >
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                    ...
                    <div style={{ display: "flex", gap: 8 }}>
                      <button
                        onClick={() => {
                          setToppingUp(company)
                          setTopUpThreshold(String(company.low_balance_threshold))
                          setTopUpError("")
                        }}
                        style={{
                          padding: "6px 14px", fontSize: 12, cursor: "pointer",
                          background: "#00aa00", color: "white", border: "none", borderRadius: 6
                        }}
                      >
                        Top Up
                      </button>
                      ...
                      <button
                        ...
                        style={{
                          padding: "6px 14px", fontSize: 12, cursor: "pointer",
                          background: "#ff444422", color: "#ff4444", border: "1px solid #ff4444", borderRadius: 6
                        }}
                      >
                        Delete
                      </button>
        ...
        <div onClick={() => setShowAddModal(false)} style={overlay}>
          <div onClick={(e) => e.stopPropagation()} style={modal}>
            ...
            <input
              ...
              onChange={(e) => { setNewCompanyName(e.target.value); setAddError("") }}
              onKeyDown={(e) => { if (e.key === "Enter") handleAddCompany() }}
              placeholder="e.g. NNPC, Total"
              style={input}
              autoFocus
            />
            ...
            <div style={{ display: "flex", gap: 8, marginTop: 24 }}>
              ...
              <button onClick={handleAddCompany} disabled={addLoading} style={primaryBtn}>
        ...
        <div onClick={() => setEditingCompany(null)} style={overlay}>
          <div onClick={(e) => e.stopPropagation()} style={modal}>
            ...
            <input
              ...
              onKeyDown={(e) => { if (e.key === "Enter") handleEditCompany() }}
              style={input}
              autoFocus
            />
            ...
            <div style={{ display: "flex", gap: 8, marginTop: 24 }}>
              ...
              <button onClick={handleEditCompany} disabled={editLoading} style={primaryBtn}>
        ...
        <div onClick={() => setToppingUp(null)} style={overlay}>
          <div onClick={(e) => e.stopPropagation()} style={modal}>
            ...
            <p style={{ color: "#888", fontSize: 13, marginBottom: 20 }}>
              Current balance: ₦{toppingUp.current_balance.toLocaleString()}
            </p>
            ...
            <input
              ...
              onChange={(e) => { setTopUpThreshold(e.target.value); setTopUpError("") }}
            ...
            <div style={{ display: "flex", gap: 8, marginTop: 24 }}>
              ...
              <button onClick={handleTopUp} disabled={topUpLoading} style={{ ...primaryBtn, background: "#00aa00" }}>
        ...
        <div onClick={() => setDeletingCompany(null)} style={overlay}>
          <div onClick={(e) => e.stopPropagation()} style={modal}>
            ...
            <p style={{ color: "#555", marginBottom: 24 }}>
              Are you sure you want to delete <strong>{deletingCompany.company_name}</strong>? This will also delete all associated deposit records.
            </p>
            <div style={{ display: "flex", gap: 8 }}>
              <button onClick={() => setDeletingCompany(null)} style={cancelBtn}>Cancel</button>
              <button onClick={handleDeleteCompany} disabled={deleteLoading} style={{ ...primaryBtn, background: "#ff4444" }}>
