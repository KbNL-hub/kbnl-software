        ...
        {tab === "side-trips" && (
          <div>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 24 }}>
              ...
              {!sideTripsLoading && sideTrips.length > 0 && (
                <div style={{ display: "flex", background: "white", border: "1px solid #e2e8f0", borderRadius: 8, padding: 4, gap: 0 }}>
                  <button
                    onClick={() => setSideTripsViewMode("card")}
                    style={{
                      padding: "8px 12px",
                      background: sideTripsViewMode === "card" ? "#0070f3" : "transparent",
                      color: sideTripsViewMode === "card" ? "white" : "#64748b",
                      border: "none",
                      borderRadius: 6,
                      cursor: "pointer",
                  ...
                  <button
                    onClick={() => setSideTripsViewMode("table")}
                    style={{
                      padding: "8px 12px",
                      background: sideTripsViewMode === "table" ? "#0070f3" : "transparent",
                      color: sideTripsViewMode === "table" ? "white" : "#64748b",
                      border: "none",
                      borderRadius: 6,
                      cursor: "pointer",
                      fontSize: FONT_SIZE.xs,
            ...
            ) : sideTripsViewMode === "table" ? (
              <div style={{ background: "white", border: "1px solid #e2e8f0", borderRadius: 12, overflow: "hidden" }}>
                <table style={{ width: "100%", borderCollapse: "collapse", fontSize: FONT_SIZE.sm }}>
                  <thead>
                    <tr style={{ background: "#f8fafc" }}>
                      <th style={{ textAlign: "left", padding: "10px 12px", borderBottom: "2px solid #e2e8f0", color: "#475569", fontWeight: 600, fontSize: FONT_SIZE.xs, textTransform: "uppercase", letterSpacing: 0.5 }}>Driver</th>
                      ...
                      <th style={{ textAlign: "left", padding: "10px 12px", borderBottom: "2px solid #e2e8f0", color: "#475569", fontWeight: 600, fontSize: FONT_SIZE.xs, textTransform: "uppercase", letterSpacing: 0.5 }}>Item</th>
